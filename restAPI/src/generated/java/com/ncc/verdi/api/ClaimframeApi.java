...
public interface ClaimframeApi {
    ...
    default ResponseEntity<List<ClaimFrameTopic>> claimFrameTopicalList() {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"template\" : \"template\", \"baseGraph\" : \"baseGraph\", \"topic\" : \"topic\", \"queryClaimId\" : \"queryClaimId\", \"description\" : \"description\", \"subtopic\" : \"subtopic\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    default ResponseEntity<List<ClaimFrame>> claimFrames(@ApiParam(value = "Filter JSON for Claim Frame"  )  @Valid @RequestBody(required = false) ClaimFrameFilterObject claimFrameFilterObject) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"epistemic\" : \"epistemic\", \"components\" : [ { \"propertyName\" : \"propertyName\", \"values\" : [ { \"componentURI\" : \"componentURI\", \"componentId\" : \"componentId\", \"system\" : \"system\", \"componentTypes\" : [ \"componentTypes\", \"componentTypes\" ], \"componentProvenance\" : \"componentProvenance\", \"componentName\" : \"componentName\", \"componentKE\" : \"componentKE\" }, { \"componentURI\" : \"componentURI\", \"componentId\" : \"componentId\", \"system\" : \"system\", \"componentTypes\" : [ \"componentTypes\", \"componentTypes\" ], \"componentProvenance\" : \"componentProvenance\", \"componentName\" : \"componentName\", \"componentKE\" : \"componentKE\" } ] }, { \"propertyName\" : \"propertyName\", \"values\" : [ { \"componentURI\" : \"componentURI\", \"componentId\" : \"componentId\", \"system\" : \"system\", \"componentTypes\" : [ \"componentTypes\", \"componentTypes\" ], \"componentProvenance\" : \"componentProvenance\", \"componentName\" : \"componentName\", \"componentKE\" : \"componentKE\" }, { \"componentURI\" : \"componentURI\", \"componentId\" : \"componentId\", \"system\" : \"system\", \"componentTypes\" : [ \"componentTypes\", \"componentTypes\" ], \"componentProvenance\" : \"componentProvenance\", \"componentName\" : \"componentName\", \"componentKE\" : \"componentKE\" } ] } ], \"locationName\" : \"locationName\", \"claimURI\" : \"claimURI\", \"claimerAffiliation\" : \"claimerAffiliation\", \"importance\" : 0.8008281904610115, \"xVariable\" : \"xVariable\", \"description\" : \"description\", \"queryClaimId\" : \"queryClaimId\", \"claimTemplate\" : \"claimTemplate\", \"dates\" : [ { \"startAfter\" : \"startAfter\", \"endBefore\" : \"endBefore\", \"startBefore\" : \"startBefore\", \"endAfter\" : \"endAfter\" }, { \"startAfter\" : \"startAfter\", \"endBefore\" : \"endBefore\", \"startBefore\" : \"startBefore\", \"endAfter\" : \"endAfter\" } ], \"claimId\" : \"claimId\", \"claimerKE\" : \"claimerKE\", \"queryId\" : \"queryId\", \"claimRelations\" : \"claimRelations\", \"claimer\" : \"claimer\", \"xVariableCompId\" : \"xVariableCompId\", \"topic\" : \"topic\", \"ranking\" : \"ranking\", \"relations\" : [ { \"propertyName\" : \"propertyName\", \"values\" : [ { \"claimLocation\" : \"claimLocation\", \"claimURI\" : \"claimURI\", \"importance\" : 6.027456183070403, \"xVariable\" : \"xVariable\", \"description\" : \"description\", \"topic\" : \"topic\", \"claimTemplate\" : \"claimTemplate\", \"dates\" : [ { \"startAfter\" : \"startAfter\", \"endBefore\" : \"endBefore\", \"startBefore\" : \"startBefore\", \"endAfter\" : \"endAfter\" }, { \"startAfter\" : \"startAfter\", \"endBefore\" : \"endBefore\", \"startBefore\" : \"startBefore\", \"endAfter\" : \"endAfter\" } ], \"claimId\" : \"claimId\", \"subtopic\" : \"subtopic\" }, { \"claimLocation\" : \"claimLocation\", \"claimURI\" : \"claimURI\", \"importance\" : 6.027456183070403, \"xVariable\" : \"xVariable\", \"description\" : \"description\", \"topic\" : \"topic\", \"claimTemplate\" : \"claimTemplate\", \"dates\" : [ { \"startAfter\" : \"startAfter\", \"endBefore\" : \"endBefore\", \"startBefore\" : \"startBefore\", \"endAfter\" : \"endAfter\" }, { \"startAfter\" : \"startAfter\", \"endBefore\" : \"endBefore\", \"startBefore\" : \"startBefore\", \"endAfter\" : \"endAfter\" } ], \"claimId\" : \"claimId\", \"subtopic\" : \"subtopic\" } ] }, { \"propertyName\" : \"propertyName\", \"values\" : [ { \"claimLocation\" : \"claimLocation\", \"claimURI\" : \"claimURI\", \"importance\" : 6.027456183070403, \"xVariable\" : \"xVariable\", \"description\" : \"description\", \"topic\" : \"topic\", \"claimTemplate\" : \"claimTemplate\", \"dates\" : [ { \"startAfter\" : \"startAfter\", \"endBefore\" : \"endBefore\", \"startBefore\" : \"startBefore\", \"endAfter\" : \"endAfter\" }, { \"startAfter\" : \"startAfter\", \"endBefore\" : \"endBefore\", \"startBefore\" : \"startBefore\", \"endAfter\" : \"endAfter\" } ], \"claimId\" : \"claimId\", \"subtopic\" : \"subtopic\" }, { \"claimLocation\" : \"claimLocation\", \"claimURI\" : \"claimURI\", \"importance\" : 6.027456183070403, \"xVariable\" : \"xVariable\", \"description\" : \"description\", \"topic\" : \"topic\", \"claimTemplate\" : \"claimTemplate\", \"dates\" : [ { \"startAfter\" : \"startAfter\", \"endBefore\" : \"endBefore\", \"startBefore\" : \"startBefore\", \"endAfter\" : \"endAfter\" }, { \"startAfter\" : \"startAfter\", \"endBefore\" : \"endBefore\", \"startBefore\" : \"startBefore\", \"endAfter\" : \"endAfter\" } ], \"claimId\" : \"claimId\", \"subtopic\" : \"subtopic\" } ] } ], \"subtopic\" : \"subtopic\", \"sourceDoc\" : \"sourceDoc\", \"sourceDocTitle\" : \"sourceDocTitle\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
